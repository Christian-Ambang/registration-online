	...
	<main>
		...
		<section class="inline-block-voir_plus">
			...
			<section class="conteneur">
				<table class="voir_plus" cellpadding="0" cellspacing="5" border="0">
					...
					$voir_plus_attente->tabDataAdulteVoirPLusInfo($_GET["ref_structure"],$_GET["ref_adherent"]);
					?>
				</table>
			</section>
		</section>
		<section class="inline-block-voir_plus">
			...
			<section class="conteneur">
				<table class="voir_plus" cellpadding="0" cellspacing="5" border="0">
					<?php 
					$voir_plus_attente=new voir_plus_attente;
					$voir_plus_attente->tabDataAdulteVoirPLusContact($_GET["ref_structure"],$_GET["ref_adherent"]);
					?>
				</table>
			</section>
		</section>
		...
		<section class="inline-block-voir_plus">
			...
			<section class="conteneur">
				<table class="voir_plus" cellpadding="0" cellspacing="5" border="0">
					<?php 
					$voir_plus_attente=new voir_plus_attente;
					$voir_plus_attente->tabDataAdulteVoirPLusEntrainement($_GET["ref_structure"],$_GET["ref_adherent"]);
					?>
				</table>
			</section>
		</section>
		<section class="inline-block-voir_plus">
			...
			<section class="conteneur">
				<table class="voir_plus_pieces" cellpadding="0" cellspacing="5" border="0">
					<?php 
					$voir_plus_attente=new voir_plus_attente;
					$voir_plus_attente->tabDataAdulteVoirPLusPieces($_GET["ref_structure"],$_GET["ref_adherent"]);
					?>
				</table>
			</section>
		</section>
		<section class="inline-block-voir_plus">
			...
			<section class="conteneur">
				<table class="voir_plus" cellpadding="0" cellspacing="5" border="0">
					<?php 
					$voir_plus_attente=new voir_plus_attente;
					$voir_plus_attente->tabDataAdulteVoirPLusEquipement($_GET["ref_structure"],$_GET["ref_adherent"]);
					?>
				</table>
			</section>
		</section>
		<section class="action">
				<div class="Pastille inline-block colRight">
					<a href="modifier-adherent-adulte.php?ref_structure=<?php echo $_GET["ref_structure"]; ?>&ref_adherent=<?php echo $_GET["ref_adherent"]?>" target="_self">Modifier</a>
				</div>
